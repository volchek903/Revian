...
def upgrade() -> None:
    with op.batch_alter_table("users", schema=None) as batch_op:
        ...
        batch_op.add_column(sa.Column("lifetime_access", sa.Boolean(), nullable=False, server_default=sa.false()))
        batch_op.add_column(sa.Column("lifetime_activated_at", sa.DateTime(timezone=True), nullable=True))
...
def downgrade() -> None:
    with op.batch_alter_table("users", schema=None) as batch_op:
        ...
        batch_op.drop_column("lifetime_activated_at")
